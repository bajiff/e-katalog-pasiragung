      ...
      <div className="relative bg-surface rounded-md shadow-lg border border-border w-full max-w-sm p-6 overflow-hidden z-10 animate-fade-in-up">
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={`px-4 py-2 text-sm font-semibold text-on-primary rounded-sm transition-opacity ${isDestructive ? 'bg-red-600 hover:opacity-90' : 'bg-primary hover:opacity-90'
              }`}
          >
            {confirmText}
          </button>
