...
const GithubIcon = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.2c3-.3 6-1.5 6-6.5a5.4 5.4 0 0 0-1.5-3.8 5.3 5.3 0 0 0-.1-3.8s-1.3-.4-4 1.5a13.3 13.3 0 0 0-7 0C6.2 1.6 5 2 5 2a5.3 5.3 0 0 0-.1 3.8A5.4 5.4 0 0 0 3.4 9.6c0 5 3 6.2 6 6.5-.4.4-.8 1.1-.8 2.2v4" />
  </svg>
);
      ...
      <div className="md:container mx-auto px-4">
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 justify-center md:justify-end">
            <a href="https://www.instagram.com/_bajif" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="Instagram">
              <InstagramIcon className="w-5 h-5" />
            </a>
            <a href="https://www.tiktok.com/@pasiragungmedia" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="TikTok">
              <TikTokIcon className="w-5 h-5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="GitHub">
              <GithubIcon className="w-5 h-5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="LinkedIn">
              <LinkedinIcon className="w-5 h-5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="X (Twitter)">
              <TwitterIcon className="w-5 h-5" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-primary transition-colors" title="Akun Saya">
